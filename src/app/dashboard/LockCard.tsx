...
const LockCard: React.FC<LockCardProps> = ({ lock }) => {
  ...
  return (
    <div className="w-full">
      <div className="w-full bg-[#000E0E] border border-[#2A2A2A] rounded-lg overflow-hidden p-4">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex items-center">
            ...
            <div>
              <div className="flex items-center">
                <div className="text-white  font-medium text-base">Lock #{lock.id}</div>
          ...
          <div className="flex items-center gap-6 ml-11 sm:ml-0">
            <div className="text-right">
              <div className="text-gray-500 text-xs">Rebase APR</div>
              <div className="text-white text-base font-medium">{lock.rebaseApr}</div>
            </div>
        ...
        <div className="flex flex-wrap justify-between items-center mt-4">
          <div className="flex flex-wrap gap-2">
            <Link
              ...
              className="px-3 py-1.5 bg-transparent text-neon-green font-medium rounded-md transition-colors text-xs whitespace-nowrap"
            >
              Increase
            </Link>
            <Link
          ...
          <button
            className="px-3 py-1.5 bg-transparent text-neon-green font-medium rounded-md transition-colors text-xs whitespace-nowrap mt-2 sm:mt-0"
            onClick={() => claim()}
            disabled={load["Claim"]}
          >
