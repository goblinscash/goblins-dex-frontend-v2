...
const SelectTokenPopup = ({ selectToken, setSelectToken }) => {
  return (
    <>
      <div
      ...
      >
        ...
        >
          ...
          <div className="top">
            <h4 className="m-0 font-bold text-xl">Select Token</h4>
          ...
          <div className="cstmBody py-3">
            <ul
              className="list-none pl-0 mb-0 overflow-auto"
              style={{
                maxHeight: "calc(100vh - 210px)",
                scrollbarWidth: "none",
              }}
            >
              <li className="p-3 rounded-lg flex items-center transition duration-[400ms] ease-in-out justify-between hover:bg-[#000]">
                <div className="left flex items-center gap-4">
                  <div className="icnWrp">{icn1}</div>
                  <div className="content">
                    <p className="m-0 text-white font-medium text-base">WETH</p>
