...
const Extend: React.FC<ExtendProps> = ({ tokenId }) => {
    ...
    // const date = duration && lock?.expires_at ? new Date(Number(lock.expires_at) * 1000 + duration * 24 * 3600000).toUTCString() : "" // Old date variable removed

    // console.log(duration) // This console.log can be removed or kept for debugging
    return (
        <>
